...
export const CourseLearningScreen = ({ route }: any) => {
    ...
    const handleLessonEnd = () => {
        const isLastLesson = activeLessonIndex === courseProduct.courseDetails.content.length - 1;
        ...
        return (
            ...
            >
                ...
                <View style={[styles.lessonInfo, isFinished && styles.leftMargin]}>
                    ...
                    <Text style={styles.lessonDuration}>{Math.floor(item.duration / 60)} mins</Text>
                </View>
            </TouchableOpacity>
        );
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.progressRow}>
                    <Progress.Bar 
                        progress={completedLessons.length / courseProduct.courseDetails.totalLessons} 
                        width={Dimensions.get('window').width - 100} 
                        color={PRIMARY_COLOR} 
                    />
                    <Text style={styles.percentageText}>
                        {Math.round((completedLessons.length / courseProduct.courseDetails.totalLessons) * 100)}%
                    </Text>
                </View>
            </View>
            <FlatList
                ...
                ListHeaderComponent={<Text style={styles.listHeader}>Course Content</Text>}
            />
